...
export type RealtimeVoiceBridgeCallbacks = {
  ...
  onTranscript?: (
    ...
    text: string,
    isFinal: boolean,
    metadata?: { providerTurnId?: string },
  ) => void;
  /** Resolved authentication decides output ownership before any provider frames arrive. */
  onOutputOwnership?: (owner: "host" | "provider") => void;
